...
$(IntermediateDirectory)/src_makemovie.cpp$(ObjectSuffix): src/makemovie.cpp $(IntermediateDirectory)/src_makemovie.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/sp2danny/extra/Fact/src/makemovie.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_makemovie.cpp$(ObjectSuffix) $(IncludePath)
