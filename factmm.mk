...
$(IntermediateDirectory)/src_factmm.cpp$(ObjectSuffix): src/factmm.cpp $(IntermediateDirectory)/src_factmm.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/sp2danny/extra/Fact/src/factmm.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_factmm.cpp$(ObjectSuffix) $(IncludePath)
